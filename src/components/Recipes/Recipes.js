			...
			return (
				<div>
					{this.state.mainRecipes.map((name, index) => (
						<RecipeListItem
							key={index}
							recipe={this.state.mainRecipes[index]}
						/>
					))}
				</div>
			);
			...
			return (
				<div>
					{this.state.sideRecipes.map((name, index) => (
						<RecipeListItem
							key={index}
							recipe={this.state.sideRecipes[index]}
						/>
					))}
				</div>
			);
			...
			return (
				<div>
					{this.state.dessertRecipes.map((name, index) => (
						<RecipeListItem
							key={index}
							recipe={this.state.dessertRecipes[index]}
						/>
					))}
				</div>
			);
			...
			return (
				<div>
					{this.state.otherRecipes.map((name, index) => (
						<RecipeListItem
							key={index}
							recipe={this.state.otherRecipes[index]}
						/>
					))}
				</div>
			);
	...
	render() {
		return (
			<div className="module" id="recipes">
				<div className="module-title">Recipes</div>
